...
from Clase_13.Book_Scraper_async.locators.quotes_pages_locators import AllBooksPageLocators
from Clase_13.Book_Scraper_async.parsers.quotes import BookParser
