...
class BinaryTree:
    ...
    def find(self, value: int):
        ...
        while current_node:
            if value == current_node.value:
                ...
                current_node = current_node.left
        raise LookupError(f'The node with value {value} was not found')
    ...
    def delete(self, value: int):
        ...
        if to_delete.left and to_delete.right:      # We have 2 children
        ...
        elif to_delete.left or to_delete.right:     # We have 1 child
            if to_delete == to_delete_parent.left:
