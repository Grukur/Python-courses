...
# var = tk.IntVar()
#
# button = tk.Button(root, text='hello', command=lambda: var.set(1))
# button.grid(column=0, row=3, sticky='NW')
#
# label = tk.Label(root, text='hello, am waiting...')
#
# print('wating.....')
# button.wait_variable(var)
# print('woho')

class PomoforoTimer(tk.Tk):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.title('Pomoforo Timer')
...
class Timer(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        stop_button = ttk.Button(button_container, text='Reset', command=self.reset_timer, cursor='hand2')
