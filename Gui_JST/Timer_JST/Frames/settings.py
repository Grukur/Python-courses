...
class Settings(ttk.Frame):
    def __init__(self, parent, controller, show_timer):
        ...
        pomodoro_label = ttk.Label(settings_container, text='Time 1 set: ', style='LightText.TLabel')
        ...
        long_break_label = ttk.Label(settings_container, text='Time 2 set: ', style='LightText.TLabel')
        ...
        short_break_label = ttk.Label(settings_container, text='Time 3 set: ', style='LightText.TLabel')
        ...
        settings_button = ttk.Button(button_container, text='Back', command=show_timer, cursor='hand2',
                                     style='PomodoroButton.TButton')
        settings_button.grid(row=0, column=0, sticky='EW', padx=2)
