...
from windows_setting import set_dpi_awareness
...
class PomodoroTimer(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        style.configure('TimerText.TLabel', background=COLOR_LIGHT_BACKGROUND, foreground=COLOR_DARK_TEXT, font='Courier 38')
        ...
        self.timer_order = ['Time 1 in process...', 'Time 2 in process...', 'Time 3 in process...']
